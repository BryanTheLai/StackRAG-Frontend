...
TARGET_DIRECTORY = r"C:\Users\wbrya\OneDrive\Documents\GitHub\frontend-ai-cfo\src"
...
DIRECTORIES_TO_SKIP = {'data','.git', '.vscode', '.idea', 'target', 'build', '__pycache__', 'node_modules', 'output_folder', 'assets'}
